            ...
            <el-row type="flex" align="bottom" justify="space-between">
              ...
              <el-col :span="7">
                <el-form-item label="类型" prop="type">
                  ...
                  >
                    ...
                    <el-option label="修改密码" value="修改密码"></el-option>
                    <el-option label="定时重启" value="定时重启"></el-option>
                  </el-select>
                </el-form-item>
              ...
              <el-col :span="8">
                <el-form-item>
                  ...
                  <el-button class="custom-btn" @click="resetForm('filterForm')"
                    >重置</el-button
                  >
...
<script>
import { getSysLogData } from "@/utils/getData";
